...
*   Object.create defines properties and Object.assign only assigns them.
    ...
    When creating a property, assignments will create it as configurable, writable and enumerable. When defining/assigning a property, you can specify those flags, but by default it's not configurable, nor writable and not enumerable.
...
let objAmaira2 = Object.create(objSo, {
	relationship: {
		configurable: true,
		enumerable: true,
		writable: true,
